            ...
            <div className="row">
                <div className="col-12">
                    ...
                    <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="1500">
                        <div className="carousel-caption text-start" style={{ zIndex: "10" }}>
                        ...
                        <div className="carousel-inner" id="carousel">
                            <div className="carousel-item active">
                                <img src="https://images.pexels.com/photos/958545/pexels-photo-958545.jpeg" className="d-block w-100 rounded-4" style={{ height: "350px", objectFit: "cover", filter: "brightness(40%)", }} alt="Delicious Food" />
                            </div>
                            <div className="carousel-item">
                                <img src="https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg" className="d-block w-100 rounded-4" style={{ height: "350px", objectFit: "cover", filter: "brightness(40%)", }} alt="Healthy Food" />
                            </div>
                            <div className="carousel-item">
                                <img src="https://images.pexels.com/photos/376464/pexels-photo-376464.jpeg" className="d-block w-100 rounded-4" style={{ height: "350px", objectFit: "cover", filter: "brightness(40%)", }} alt="Fast Delivery" />
                            </div>
                        </div>
